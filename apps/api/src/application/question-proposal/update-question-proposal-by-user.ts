...
import type { UpdateQuestionProposalInput } from "./update-question-proposal-by-admin.ts";

export class UpdateQuestionProposalByUser {
  constructor(
  ...
  async execute(
    input: UpdateQuestionProposalInput & { callerId: string },
